...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/oreo/team10_ws/src/navigation)
  set(navigation_DEVEL_PREFIX /home/oreo/team10_ws/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/oreo/team10_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'oreo <oreo@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/oreo/team10_ws/src/navigation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/oreo/team10_ws/devel/lib;/opt/ros/kinetic/lib)
